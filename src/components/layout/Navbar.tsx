        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-sm font-bold tracking-widest uppercase text-slate-800 font-sans flex items-center gap-2">
              GEOSPATIAL ANALYSIS NODE v4.0 <span className="text-blue-600">/</span>{" "}
              <span className="text-slate-500">MineOS</span>
            </h1>
            <p className="text-[10px] text-slate-500 font-mono">SESSION: X-772-OMEGA | LIVE ENCRYPTION ACTIVE</p>
          </div>
        </div>
      </div>
